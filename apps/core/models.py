...
class Exercise(models.Model):
    ...
    THUMBNAIL_POSITIONS = {
        "Shoulder Pendulum": "0% 0%",
        "Heel Slides": "25% 0%",
        "Quadriceps Sets": "50% 0%",
        "Straight Leg Raise": "75% 0%",
        "Ankle Pumps": "100% 0%",
        "Neck Stretch": "0% 100%",
        "Hamstring Stretch": "25% 100%",
        "Wall Slides": "50% 100%",
        "Bridge Exercise": "75% 100%",
        "Cat-Cow Stretch": "100% 100%",
    }

    @property
    def thumbnail_position(self):
        return self.THUMBNAIL_POSITIONS.get(self.title, "50% 50%")
...
class Prescription(models.Model):
    ...
    medicine_entries = models.JSONField(default=list, blank=True)
    instructions = models.TextField(blank=True)
